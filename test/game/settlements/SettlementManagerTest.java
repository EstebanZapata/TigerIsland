...
public class SettlementManagerTest {
    ...
    @Test
    public void testMergingExpandingSettlements() throws
            IllegalTilePlacementException,
            BuildConditionsNotMetException,
            NoHexesToExpandToException
    {
        ...
        Settlement newSettlement2 = this.settlementManager.foundSettlement(expansionTile2.getLeftHexRelativeToVolcano());
        Settlement newSettlement1 = this.settlementManager.foundSettlement(expansionTile1.getRightHexRelativeToVolcano());

        this.settlementManager.expandSettlement(newSettlement1, Terrain.JUNGLE);

        Assert.assertEquals(newSettlement2, newSettlement1);

        Hex jungleHex0 = world.getHexByCoordinate(0,0,0);
        Hex jungleHex1 = world.getHexByCoordinate(-1,0,0);
        Hex jungleHex2 = world.getHexByCoordinate(1,2,0);
        Hex jungleHex3 = world.getHexByCoordinate(0,2,0);
        Hex jungleHex4 = world.getHexByCoordinate(-1,2,0);

        Settlement jungleHex0SettlementReturned = jungleHex0.getSettlement();
        Settlement jungleHex1SettlementReturned = jungleHex1.getSettlement();
        Settlement jungleHex2SettlementReturned = jungleHex2.getSettlement();
        Settlement jungleHex3SettlementReturned = jungleHex3.getSettlement();
        Settlement jungleHex4SettlementReturned = jungleHex4.getSettlement();

        Assert.assertEquals(newSettlement1, jungleHex0SettlementReturned);
        Assert.assertEquals(newSettlement1, jungleHex1SettlementReturned);
        Assert.assertEquals(newSettlement1, jungleHex2SettlementReturned);
        Assert.assertEquals(newSettlement1, jungleHex3SettlementReturned);
        Assert.assertEquals(newSettlement1, jungleHex4SettlementReturned);
