...
import static game.settlements.BuildAction.BUILT_TOTORO_SANCTUARY;
...
public class Ai {
    ...
    private int totorroCount;
    private int settleCount;
    public Player p1;
    public Player p2;
    public World world;
    public Location previousBuildHex = null;
    private BuildAction buildType;
        ...
        try{
            ...
            boolean canBuildTotoro = false;
                ...
                if (previousBuildHex == null) {
                    ...
                    settleCount = 0;
                    if (playerID == p1.playerID&& totorroCount > 0) {
                        ...
                        try {
                            ...
                            buildType = BUILT_TOTORO_SANCTUARY;
                            totorroCount--;
            ...
            if(villagerCount<0){
                return new GameActionMessage(gameID, moveNumber, playerID, tileToBePlaced, locationOfNewTile, NORTHEAST_NORTHWEST, UNABLE_TO_BUILD, locationOnWhichToBuild, GRASSLANDS);

            }
            return new GameActionMessage(gameID, moveNumber, playerID, tileToBePlaced, locationOfNewTile, NORTHEAST_NORTHWEST, buildType, locationOnWhichToBuild, GRASSLANDS);
